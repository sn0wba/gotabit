...
import (
	...
	"github.com/gotabit/gotabit/docs"
...
func New(
	...
	return cosmoscmd.App(New(logger, db, traceStore, loadLatest, skipUpgradeHeights, homePath, invCheckPeriod, encodingConfig, appOpts, baseAppOptions...))
}
